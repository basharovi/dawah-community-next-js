        ...
        <div className="relative z-10">
          ...
          >
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              দাওয়াহ কমিউনিটি গোবী একটি অলাভজনক ইসলামিক সংগঠন যা সমাজে ইসলামের সঠিক বার্তা ছড়িয়ে দেওয়ার লক্ষ্যে কাজ করে। আমরা বিভিন্ন শিক্ষামূলক কর্মসূচি, সামাজিক সেবা এবং সম্প্রদায়ের উন্নয়নে নিবেদিত।
            </p>
          </motion.div>
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    আমাদের প্রধান লক্ষ্য হল সমাজে ইসলামের সঠিক বার্তা পৌঁছে দেওয়া, তরুণদের মধ্যে ইসলামিক মূল্যবোধ বিকাশ করা, এবং সাম্প্রদায়িক সম্প্রীতি এবং সহানুভূতি বাড়ানো। আমরা বিশ্বাস করি যে সমাজের পরিবর্তন আসে সঠিক জ্ঞান ও শিক্ষার মাধ্যমে।
                  </p>
                  <div className="pt-4 mt-4 border-t border-gray-100">
